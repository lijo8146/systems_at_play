...
> **Project theme:** Computational systems thinking through games and simulation.

---

## What it models

Cities are nodes in a weighted graph. Each edge represents a travel route — higher weight means more passenger movement and faster cross-city spread. The disease evolves each "week" (step) through:
...
Nodes coloured yellow → red by infection rate. Node size ∝ population. Edge thickness ∝ travel weight. Blue outlines indicate quarantined cities.
...
Board game mechanics are underrated as a framework for teaching systems dynamics. *Pandemic* is essentially a cooperative optimization problem over a stochastic graph — the same structure that appears in epidemiology, supply chain risk, and environmental spread modeling.
